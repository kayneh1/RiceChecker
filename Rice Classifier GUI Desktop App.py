...
class RiceClassifierApp:
    def __init__(self, master):
        ...
        self.area_label = tk.Label(master, text="Area (pixels)")
        ...
        self.perimeter_label = tk.Label(master, text="Perimeter (pixels)")
        ...
        self.majat_label = tk.Label(master, text="Major axis length (pixels)")
        ...
        self.minat_label = tk.Label(master, text="Minor axis length (pixels)")
        ...
        self.eccen_label = tk.Label(master, text="Eccentricity (pixels)")
        ...
        self.convex_label = tk.Label(master, text="Convex area (pixels)")
        ...
        self.extent_label = tk.Label(master, text="Extent (pixels)")
